    ...
    def __init__(self):
        ...
        self.defaults_configs = {
            ...
            'html_message_template': (
                "HTML_MESSAGE_TEMPLATE",
                'user_app/email_verification_msg.html'
            ),
            ...
            'verification_success_template': (
                'VERIFICATION_SUCCESS_TEMPLATE',
                'user_app/email_verification_successful.html'
            ),

            'verification_success_msg': (
                'VERIFICATION_SUCCESS_MSG',
                "Your email has been successfully verified and your account has been activated. "
                "You may proceed to login."
            ),

            'verification_failed_template': (
                'VERIFICATION_FAILED_TEMPLATE',
                'user_app/email_verification_failed.html'
            ),

            'link_expired_template': (
                'LINK_EXPIRED_TEMPLATE',
                'user_app/link_expired.html'
            ),

            'verification_failed_msg': (
                'VERIFICATION_FAILED_MSG',
                "There is something wrong with this link, we can't verify the user..."
            ),
            'request_new_email_template': (
                'REQUEST_NEW_EMAIL_TEMPLATE',
                'user_app/request_new_email.html'
            ),
            'new_email_sent_template': (
                'NEW_EMAIL_SENT_TEMPLATE',
                'user_app/new_email_sent.html'
            ),
